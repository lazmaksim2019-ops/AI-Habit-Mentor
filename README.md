...
Методология **Мета-К.О.Д.** (автор метода — Александр Лазаренко) основана на теории функциональных систем П.К. Анохина и учении о доминанте А.А. Ухтомского. Никаких банальных советов — только научно обоснованная инженерия поведения.
